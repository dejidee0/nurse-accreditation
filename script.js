// Main JavaScript for NNEC Website
    ...
    if (message) {
        ...
        setTimeout(() => {
            const responses = [
                ...
                "For immediate assistance, you can also call our support line at +234 800 NNEC (6632).",
                "Would you like information about our upcoming certification programs or examination schedules?",
                "I can help you with registration, payment processes, or any questions about NNEC services."
            ];
...
document.querySelectorAll('.stat-card, .event-card, .section-header').forEach(el => {
    observer.observe(el);
});
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const savedChatState = getFromLocalStorage('nnec_chat_state');
